...
function Preproc_ses9 (subjects)
tic
parpool;
global CCN;
...
output_fig='output_figures_ses-9'; %this will put your output figures into output_figures folder under the specified session
