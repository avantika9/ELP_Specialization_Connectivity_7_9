...
parpool;
addpath(genpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/Scripts_AM/spm12_elp'));
addpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/Scripts_AM/spm12_elp/toolbox');
addpath(genpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/LabTools'));
addpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/Conn_PhonSem_AM_7_9');
marsbar('on');
...
rootDIR  = '/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/Conn_PhonSem_AM_7_9/preprocessed';
...
%roi_file_root = '/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/Conn_PhonSem_AM_7_9/preprocessed/AM_ROIs/ROIs/ses7_phon_specialization';
roi_file_root = '/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/Conn_PhonSem_AM_7_9/preprocessed/AM_ROIs/ROIs/ses7_sem_specialization';
%what is your model directory?
%PPImodelDIR = ['PPI_VOI_l_IFGop_gPPI'];
PPImodelDIR = ['PPI_VOI_l_IFGtri_gPPI'];
...
% set parameters
%namerois = {'pSTG_onsetrhyme_vs_perc_VS_weakstrong_vs_perc_p1_k100'};
namerois = {'pMTG_weakstrong_vs_perc_VS_onsetrhyme_vs_perc_p1_k100'};
...
%  'Sn(1) PPI_P_C' 'Sn(1) PPI_P_O' 'Sn(1) PPI_P_R' 'Sn(1) PPI_P_U' 'Sn(1) VOI_l_IFGop_gPPI_seedtc' ...
%  'Sn(1) m1' 'Sn(1) m2' 'Sn(1) m3' 'Sn(1) m4' 'Sn(1) m5' 'Sn(1) m6'  ...
%  'Sn(2) P_C*bf(1)' 'Sn(2) P_O*bf(1)' 'Sn(2) P_R*bf(1)' 'Sn(2) P_U*bf(1)'...
%  'Sn(2) PPI_P_C' 'Sn(2) PPI_P_O' 'Sn(2) PPI_P_R' 'Sn(2) PPI_P_U' 'Sn(2) VOI_l_IFGop_gPPI_seedtc' ...
%  'Sn(2) m1' 'Sn(2) m2' 'Sn(2) m3' 'Sn(2) m4' 'Sn(2) m5' 'Sn(2) m6' ...
%  'Sn(3) S_C*bf(1)' 'Sn(3) S_H*bf(1)' 'Sn(3) S_L*bf(1)' 'Sn(3) S_U*bf(1)' ...
%  'Sn(3) PPI_S_C' 'Sn(3) PPI_S_H' 'Sn(3) PPI_S_L' 'Sn(3) PPI_S_U' 'Sn(3) VOI_l_IFGop_gPPI_seedtc' ...
%  'Sn(3) m1' 'Sn(3) m2' 'Sn(3) m3' 'Sn(3) m4' 'Sn(3) m5' 'Sn(3) m6' ...
%  'Sn(4) S_C*bf(1)' 'Sn(4) S_H*bf(1)' 'Sn(4) S_L*bf(1)' 'Sn(4) S_U*bf(1)' ...
%  'Sn(4) PPI_S_C' 'Sn(4) PPI_S_H' 'Sn(4) PPI_S_L' 'Sn(4) PPI_S_U' 'Sn(4) VOI_l_IFGop_gPPI_seedtc' ...
%  'Sn(4) m1' 'Sn(4) m2' 'Sn(4) m3' 'Sn(4) m4' 'Sn(4) m5' 'Sn(4) m6' ...
%  'Sn(1) constant' 'Sn(2) constant' 'Sn(3) constant' 'Sn(4) constant'};
 
 nameconditions = {'Sn(1) P_C*bf(1)' 'Sn(1) P_O*bf(1)' 'Sn(1) P_R*bf(1)' 'Sn(1) P_U*bf(1)' ...
 'Sn(1) PPI_P_C' 'Sn(1) PPI_P_O' 'Sn(1) PPI_P_R' 'Sn(1) PPI_P_U' 'Sn(1) VOI_l_IFGtri_gPPI_seedtc' ...
 'Sn(1) m1' 'Sn(1) m2' 'Sn(1) m3' 'Sn(1) m4' 'Sn(1) m5' 'Sn(1) m6'  ...
 'Sn(2) P_C*bf(1)' 'Sn(2) P_O*bf(1)' 'Sn(2) P_R*bf(1)' 'Sn(2) P_U*bf(1)'...
 'Sn(2) PPI_P_C' 'Sn(2) PPI_P_O' 'Sn(2) PPI_P_R' 'Sn(2) PPI_P_U' 'Sn(2) VOI_l_IFGtri_gPPI_seedtc' ...
 'Sn(2) m1' 'Sn(2) m2' 'Sn(2) m3' 'Sn(2) m4' 'Sn(2) m5' 'Sn(2) m6' ...
 'Sn(3) S_C*bf(1)' 'Sn(3) S_H*bf(1)' 'Sn(3) S_L*bf(1)' 'Sn(3) S_U*bf(1)' ...
 'Sn(3) PPI_S_C' 'Sn(3) PPI_S_H' 'Sn(3) PPI_S_L' 'Sn(3) PPI_S_U' 'Sn(3) VOI_l_IFGtri_gPPI_seedtc' ...
 'Sn(3) m1' 'Sn(3) m2' 'Sn(3) m3' 'Sn(3) m4' 'Sn(3) m5' 'Sn(3) m6' ...
 'Sn(4) S_C*bf(1)' 'Sn(4) S_H*bf(1)' 'Sn(4) S_L*bf(1)' 'Sn(4) S_U*bf(1)' ...
 'Sn(4) PPI_S_C' 'Sn(4) PPI_S_H' 'Sn(4) PPI_S_L' 'Sn(4) PPI_S_U' 'Sn(4) VOI_l_IFGtri_gPPI_seedtc' ...
 'Sn(4) m1' 'Sn(4) m2' 'Sn(4) m3' 'Sn(4) m4' 'Sn(4) m5' 'Sn(4) m6' ...
 'Sn(1) constant' 'Sn(2) constant' 'Sn(3) constant' 'Sn(4) constant'};
...
%  'PPI_P_C' 'PPI_P_O' 'PPI_P_R' 'PPI_P_U' 'VOI_l_IFGop_gPPI_seed' ...
%  'm1' 'm2' 'm3' 'm4' 'm5' 'm6'  ...
%  'P_C_contrast' 'P_O_contrast' 'P_R_contrast' 'P_U_contrast'...
%  'PPI_P_C' 'PPI_P_O' 'PPI_P_R' 'PPI_P_U' 'VOI_l_IFGop_gPPI_seed' ...
%  'm1' 'm2' 'm3' 'm4' 'm5' 'm6' ...
%  'S_C_contrast' 'S_H_contrast' 'S_L_contrast' 'S_U_contrast' ...
%  'PPI_S_C' 'PPI_S_H' 'PPI_S_L' 'PPI_S_U' 'VOI_l_IFGop_gPPI_seed' ...
%  'm1' 'm2' 'm3' 'm4' 'm5' 'm6' ...
%  'S_C_contrast' 'S_H_contrast' 'S_L_contrast' 'S_U_contrast' ...
%  'PPI_S_C' 'PPI_S_H' 'PPI_S_L' 'PPI_S_U' 'VOI_l_IFGop_gPPI_seed' ...
%  'm1' 'm2' 'm3' 'm4' 'm5' 'm6' ...
%  'constant1' 'constant2' 'constant3' 'constant4'};
 friendlyconditions= {'P_C_contrast' 'P_O_contrast' 'P_R_contrast' 'P_U_contrast' ...
 'PPI_P_C' 'PPI_P_O' 'PPI_P_R' 'PPI_P_U' 'VOI_l_IFGtri_gPPI_seed' ...
 'm1' 'm2' 'm3' 'm4' 'm5' 'm6'  ...
 'P_C_contrast' 'P_O_contrast' 'P_R_contrast' 'P_U_contrast'...
 'PPI_P_C' 'PPI_P_O' 'PPI_P_R' 'PPI_P_U' 'VOI_l_IFGtri_gPPI_seed' ...
 'm1' 'm2' 'm3' 'm4' 'm5' 'm6' ...
 'S_C_contrast' 'S_H_contrast' 'S_L_contrast' 'S_U_contrast' ...
 'PPI_S_C' 'PPI_S_H' 'PPI_S_L' 'PPI_S_U' 'VOI_l_IFGtri_gPPI_seed' ...
 'm1' 'm2' 'm3' 'm4' 'm5' 'm6' ...
 'S_C_contrast' 'S_H_contrast' 'S_L_contrast' 'S_U_contrast' ...
 'PPI_S_C' 'PPI_S_H' 'PPI_S_L' 'PPI_S_U' 'VOI_l_IFGtri_gPPI_seed' ...
 'm1' 'm2' 'm3' 'm4' 'm5' 'm6' ...
...
for w = roi
    ...
    E=[];
        ...
        if roistore == 1
            if (roi_is_image)
            roi_file = char([char(roi_file_root) filesep char(thisroi) char('_roi.nii')]);  %IF .NII FILE
        ...
        elseif roistore== 2
            if (roi_is_image)
            roi_file = char([char(roi_file_root) filesep char(thisguy) filesep char(thisroi) char('_roi.nii')]);  %IF .NII FILE
            R = maroi_image(roi_file);
            else
