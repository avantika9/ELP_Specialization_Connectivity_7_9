...
addpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM/ELP/Scripts_AM/PPI_analysis/gPPI/PPPIv13');
...
root='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM/ELP/Conn_PhonSem_AM_7_9/preprocessed';
model_dir='ses7_analysis/deweight';
VOIref='indiv_mask'; %or group_mask
%seedregion='l_pSTG';%
seedregion='l_pMTG';%

%ROI_folder= 'AM_ROIs/ROIs_amendment/ses7_phon_specialization';
ROI_folder= 'AM_ROIs/ROIs_amendment/ses7_sem_specialization';
...
conditions={ '0' 'P_C' 'P_O' 'P_R' 'P_U' 'S_C' 'S_H' 'S_L' 'S_U'};
...
% contrasts{1}={'rhyme' 'perceptual'};
% contrasts{2}={'onset' 'perceptual'};
...
%      switch VOIref
%         case 'indiv_mask'
%             P.masks=[root '/' ROI_folder '/'  subjects{num} '/' mask_name];
%         case 'group_mask'
%             P.masks=[root '/' ROI_folder '/' mask_name];
%     end
...
%         P.Contrasts(i).name=[contrasts{i}{1} '_vs_' contrasts{i}{2}];
%     end
    ...
    %   VOImin:     sets the minimum VOI sizeSPM
