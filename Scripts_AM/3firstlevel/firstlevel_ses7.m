...
function firstlevel_ses7 (subjects)
parpool;
addpath(genpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/Scripts_AM/3firstlevel')); % the path of your scripts
%spm_path='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/spm12_elp';%the path of spm
spm_path='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM/ELP/Scripts_AM/spm12_elp';
addpath(genpath(spm_path));
analysis_folder='ses7_analysis'; % the name of your first level modeling folder different for ses-7 and ses-9
