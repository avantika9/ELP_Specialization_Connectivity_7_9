...
function firstlevel_ses9 (subjects)
parpool;
addpath(genpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/typical_data_analysis/3firstlevel')); % the path of your scripts
%spm_path='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/spm12_elp';%the path of spm
spm_path='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/typical_data_analysis/spm12_elp';
addpath(genpath(spm_path));
analysis_folder='ses9_analysis'; % the name of your first level modeling folder different for ses-7 and ses-9

% define your data path
data=struct();
root='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AM_ELP/Conn_PhonSem_AM_7_9';  %your project path
