...
% As per reviewers comments this script is used to extract betas for
% semantic specialization at age7 using the ROIS at age 7.
%%%%%%%%%%%%%%%%%%%%%%%%%
% None of this works without Marsbar being turned on
%%%%%%%%%%%%%%%%%%%%%%%%%
%initialize SPM and path
addpath(genpath('/panfs/accrepfs.vampire/data/booth_lab/LabCode/typical_data_analysis/spm12_elp'));
addpath('/panfs/accrepfs.vampire/data/booth_lab/LabCode/typical_data_analysis/spm12_elp/toolbox');
marsbar('on');
...
rootDIR  = '/panfs/accrepfs.vampire/data/booth_lab/AM/ELP/Conn_PhonSem_AM_7_9/preprocessed';
...
ROIdir = '/panfs/accrepfs.vampire/data/booth_lab/AM/ELP/templates_cerebroMatic/AM_ROIs/ROIs';
roi_file_root = [ROIdir '/ses7_sem_specialization'];

%what is your model directory?
modelDIR = ['/ses9_analysis/deweight'];

% make sure the scriptdir is in the path
%addpath(pwd);
addpath ('/panfs/accrepfs.vampire/data/booth_lab/AM/ELP/Scripts_AM/Get_betas');
% set parameters
...
namesubjects ={}; %The subject in your individual ROIs folder

data_info='/panfs/accrepfs.vampire/data/booth_lab/AM/ELP/Conn_PhonSem_AM_7_9/preprocessed/Subject_selection.xlsx';
...
%prefix+the roi name
fprefix='betas_ses9'; %it's also possible to make our results file have a prefix.
